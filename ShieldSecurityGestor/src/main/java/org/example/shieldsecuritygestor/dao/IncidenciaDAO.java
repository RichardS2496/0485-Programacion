...
public class IncidenciaDAO {
    ...
    public List<Incidencia> obtenerTodasIncidencias() {
        ...
        String query = "SELECT i.id_incidencia, i.titulo, i.descripcion, i.severidad, i.estado, i.fecha_apertura, i.fecha_cierre FROM incidencia i JOIN contrato c ON i.id_contrato = c.id_contrato";
